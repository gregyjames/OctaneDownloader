...
namespace OctaneEngine.ShellProgressBar
{
	public abstract class ProgressBarBase
	{
		...
		protected ProgressBarBase(int maxTicks, string message, OctaneEngine.ShellProgressBar.ProgressBarOptions options)
		{
			this._maxTicks = Math.Max(0, maxTicks);
			this._message = message;
			this.Options = options ?? OctaneEngine.ShellProgressBar.ProgressBarOptions.Default;
		}

		internal OctaneEngine.ShellProgressBar.ProgressBarOptions Options { get; }
		internal ConcurrentBag<OctaneEngine.ShellProgressBar.ChildProgressBar> Children { get; } = new ConcurrentBag<OctaneEngine.ShellProgressBar.ChildProgressBar>();

		protected abstract void DisplayProgress();

		protected virtual void Grow(OctaneEngine.ShellProgressBar.ProgressBarHeight direction) { }
		...
		public OctaneEngine.ShellProgressBar.ChildProgressBar Spawn(int maxTicks, string message, OctaneEngine.ShellProgressBar.ProgressBarOptions options = null)
		{
			...
			var pbar = new OctaneEngine.ShellProgressBar.ChildProgressBar(
